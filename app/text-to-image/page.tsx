...
import {fetchModels,generateImage,setPrompt,setSelectedModel } from "@/lib/features/artSlice";
           ...
           {generatedImage && (
              <div className="bg-gray-800/50 rounded-xl p-4 sm:p-6 border border-purple-500/50">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg sm:text-xl font-bold text-white">Generated Image</h3>
                </div>
                <img
                  src={generatedImage}
